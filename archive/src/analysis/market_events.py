...
PRESET_EVENTS = [
    # 2024 年
    {
        ...
        "type": "ETF",
        "impact": "bullish",
        "title": "BTC Spot ETF 获批",
        "desc": "SEC 批准 11 只比特币现货 ETF",
    },
    {
        "date": "2024-03-14",
        "type": "PRICE",
    ...
    },
    {
        ...
        "impact": "neutral",
        "title": "BTC 第四次减半",
        "desc": "区块奖励从 6.25 降至 3.125 BTC",
    },
    {
        "date": "2024-05-23",
        "type": "ETF",
        "impact": "bullish",
        "title": "ETH Spot ETF 获批预期",
        "desc": "SEC 180 态度转变，ETH ETF 申请获推进",
    },
    {
        "date": "2024-07-23",
        "type": "ETF",
        "impact": "bullish",
        "title": "ETH Spot ETF 上市",
        "desc": "以太坊现货 ETF 正式在美国上市",
    },
    {
        "date": "2024-08-05",
        "type": "MACRO",
...
class MarketEventDB:
    ...
    def add_event(self, date: str, event_type: str, impact: str, title: str, description: str = "") -> None:
        """添加事件。"""
    ...
    def get_events(self, event_type: str | None = None, impact: str | None = None) -> pd.DataFrame:
        """查询事件。"""

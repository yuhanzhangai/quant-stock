...
_ROWS = [
    ...
    ("t1", "alpha", "100", "alpha", "Alpha", "2026-06-09T10:00:00+00:00", 1780000000,
     "NVDA to the moon", "twscrape", 5, 1, 0, 100, "https://x.com/alpha/status/t1",
     '["NVDA"]', None, 0, "bullish", 0.9, 0),
    ("t2", "beta", "200", "beta", "Beta", "2026-06-09T11:00:00+00:00", 1780000100,
     "TSLA short setup", "twscrape", 2, 0, 0, 50, "https://x.com/beta/status/t2",
     '["TSLA"]', '[{"type":"photo","url":"https://pbs.example/img.jpg"}]', 1, "bearish", -0.7, 0),
    ("t3", "gamma", "300", "gamma", "Gamma", "2026-06-09T12:00:00+00:00", 1780000200,
     "blocked content", "twscrape", 0, 0, 0, 10, "https://x.com/gamma/status/t3",
     "[]", None, 0, "neutral", 0.0, 1),
]
